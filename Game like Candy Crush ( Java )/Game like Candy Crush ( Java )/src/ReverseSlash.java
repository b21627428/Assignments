...
public class ReverseSlash extends MathSymbol{
    ...
    public boolean middle( int rowCoordinate , int columnCoordinate ,int row ,int column ,Jewel[][] array ){ // Koordinat mapin ortasında bulunuyorsa bu fonksiyon gerçekleşir.
       ...
       if( (columnCoordinate == 1 && rowCoordinate < (row-2)) ||(rowCoordinate == 1 && columnCoordinate < (column-2)) ) {
           
           test = rightDownDiagonalChecking(rowCoordinate, columnCoordinate, array);
       }
       else if ( (columnCoordinate == (column-2) && rowCoordinate > 1) || (rowCoordinate == (row-2) && columnCoordinate > 1) ){
           ...
           test = leftUpDiagonalChecking(rowCoordinate, columnCoordinate, array);
            ...
            if ( ! ( ( columnCoordinate == 1 && rowCoordinate == (row-2) ) || ( columnCoordinate == (column-2) && rowCoordinate == 1 ) ) ){
    ...
    public boolean rightDownDiagonalChecking( int rowCoordinate , int columnCoordinate , Jewel[][] array ){  //Koordinat ın 9 kısmını check eder.
        ...
        if(  array[rowCoordinate+1][columnCoordinate+1] instanceof ReverseSlash && array[rowCoordinate+2][columnCoordinate+2] instanceof MathSymbol    ){
